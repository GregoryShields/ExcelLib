...
{
	/// <summary>
	/// Attempting to call Marshal.GetActiveObject() raises this error in .NET Core:
	/// Error CS0117 'Marshal' does not contain a definition for 'GetActiveObject'
	/// Therefore, we have gone to the source code of the .NET Framework version of
	/// the Marshal class and copied the code to a new class called Marshal2.
